...
RSpec.describe Item do 
  ...
  #copied this over from market - vendor and vendor1 are the same for the sake
  #of respecting the interaction pattern
  let(:item1) { Item.new({name: 'Peach', price: "$0.75"}) }
  let(:item2) { Item.new({name: 'Tomato', price: '$0.50'}) }
  ...
  describe "#potential_revenue" do 
    it "can calculate potential revenue based on item quantities and stock" do 
